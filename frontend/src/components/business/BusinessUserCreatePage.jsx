...
class BusinessUserCreatePage extends Component {
  render() {
    return (
      ...
      <>
        <Container>
          ...
          <LabeledTextAreaInput
            ...
            placeholder="Enter rules of conduct"
            controlId="rulesInput"
          />
...
export default BusinessUserCreatePage;
