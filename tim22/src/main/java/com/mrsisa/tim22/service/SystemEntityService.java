...
public class SystemEntityService {
    ...
    public ArrayList<SystemEntityDTO> getEntities(){
        ...
        entities.add(new SystemEntityDTO("https://www.gradnja.rs/wp-content/uploads/2022/02/luksuzne-vikendice-srbija-izajmljivanje-gradnja.rs_.jpg", "Puz", 500, 3, "Njegoseva 22", "VACATION"));
        entities.add(new SystemEntityDTO("https://www.gradnja.rs/wp-content/uploads/2021/01/balaton-vikendica.jpg", "Kuzis", 300, 4, "Petra Kocica 38, Jagodina", "VACATION"));
        entities.add(new SystemEntityDTO("https://cf.bstatic.com/xdata/images/hotel/max1024x768/187868702.jpg?k=4368f5637f7ff4c79e5c7f993e37c48850d3e9d7d514486c15e971a4aa45ed38&o=&hp=1", "Nesto", 200, 5, "Alekse Santica 4, Novi Sad", "VESSEL"));
        entities.add(new SystemEntityDTO("https://www.gdenaplaninu.com/uploads/images/objekti/200/vikendicA.jpg", "Nesto", 200, 5, "Alekse Santica 26, Novi Sad", "ADVENTURE"));
        entities.add(new SystemEntityDTO("https://media.mojtrg.rs/Image/ce9e459c7a9e46bdb35cd246288f903b/20150907/false/false/1280/960/Vikendica-od-65m2--Kopaonik.jpeg", "Nesto", 200, 5, "Alekse Santica 11, Novi Sad", "ADVENTURE"));
        entities.add(new SystemEntityDTO("https://www.mojenterijer.rs/storage/posts/gallery/2017/Dec/115648/sarmantna-vikendica-u-kanadi.jpg", "Nesto", 200, 5, "Alekse Santica 22, Novi Sad","VACATION"));
        entities.add(new SystemEntityDTO("https://img.halooglasi.com/slike/oglasi/Thumbs/200904/l/prodaje-se-vikendica-25-m2-g-goracici-prijepo-5425635877817-71792611911.jpg", "Nesto", 200, 5, "Brace Ribnika, Novi Sad", "VACATION"));
        entities.add(new SystemEntityDTO("http://sveoosiguranju.rs/wp-content/uploads/2015/11/bjr09xv43ev38ei8feec.jpg", "Nesto", 200, 5, "Gogoljeva, Novi Sad","VESSEL"));
    ...
    private SystemEntityDTO createEntityDTO(SystemEntity entity) {
        ...
        return new SystemEntityDTO(photo, entity.getName(), entity.getPrice(), entity.getAverageScore(), address,"VACATION");
    }
